...
public abstract class Gun : MonoBehaviour
{
    ...
    protected int MaxAmmo => (int)Mathf.Ceil(baseMaxAmmo * entityData.ammoMultiplier);
    ...
    {
        Projectile bullet = ProjectilePoolManager.Instance.GetProjectile(prefab).GetComponent<Projectile>();
